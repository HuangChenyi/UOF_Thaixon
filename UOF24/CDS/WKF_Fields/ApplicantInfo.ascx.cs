...
public partial class WKF_OptionalFields_ApplicantInfo : WKF_FormManagement_VersionFieldUserControl_VersionFieldUC
{
    ...
    public override string DisplayTitle
    {
        get
        {
            //表單查詢或WebPart顯示的標題
            //回傳字串
            return $"公司別:{lblCompany.Text}-廠別:{lblFactory.Text}";
        }
    }
    ...
    public override string FieldValue
    {
        get
        {
            ...
            //<FieldValue company='公司別' factory='廠別' groupName='部門名稱' groupNo='部門編號' employeeNo='員編' />

            XmlDocument xmlDoc = new XmlDocument(); 
            XmlElement xmlElement = xmlDoc.CreateElement("FieldValue");
            xmlElement.SetAttribute("company", lblCompany.Text);
            xmlElement.SetAttribute("factory", lblFactory.Text);
            xmlElement.SetAttribute("groupName", lblDeptName.Text);
            xmlElement.SetAttribute("groupNo", lblDeptCode.Text);
            xmlElement.SetAttribute("employeeNo", lblEmployeeNo.Text);
    ...
    public override void SetField(Ede.Uof.WKF.Design.VersionField versionField)
    {
        ...
        if (fieldOptional != null)
        {
            ...
            if(!string.IsNullOrEmpty( base.ApplicantGuid))
            {
                ...
                lblEmployeeNo.Text= ebUser.EmployeeNo;
    ...
    private string GetFactroy(string groupId)
    {
        ...
        {
            return GetFactroy(bg.ParnetGroup.GroupId);
        }
