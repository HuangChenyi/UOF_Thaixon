<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeFile="SetupField_OrderInfo.aspx.cs" Inherits="WKF_OptionalFields_SetupField_OrderInfo" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><center><asp:Label ID="lblSingleLine" runat="server" Text="訂單資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
